...
Just a calm, intelligent companion that listens, reflects, and helps you understand yourself a little better—on your own terms.

For self-aware adults who want support without the weight of therapy or the hype of coaching.`,

    // What it is / isn't
    whatItIs: [
      "A private space for emotional reflection",
      "An intelligent companion that listens without judgment",
      "A way to notice patterns in how you feel over time",
    ],
    whatItIsNot: [
      "Not a therapist or medical treatment",
      "Not a coach with goals and accountability",
      "Not a habit tracker or productivity app",
    ],
    ...
    // Who it's for
    forWho: [
      "Self-aware adults seeking reflection",
      "Professionals managing mental load",
      "Anyone wanting support without the weight of therapy",
    ],
    notForWho: [
      "Those in acute mental health crisis (we provide resources)",
      "Those seeking diagnosis or medical advice",
      "Those wanting structured self-improvement programs",
    ],
  },
  de: {
    statement:
...
Einfach ein ruhiger, intelligenter Begleiter, der zuhört, reflektiert, und dir hilft, dich selbst ein wenig besser zu verstehen—nach deinen Regeln.

Für selbstreflektierte Erwachsene, die Unterstützung ohne das Gewicht von Therapie oder den Hype von Coaching suchen.`,

    whatItIs: [
      "Ein privater Raum für emotionale Reflexion",
      "Ein intelligenter Begleiter, der ohne Urteil zuhört",
      "Ein Weg, Muster in deinem Befinden über Zeit zu erkennen",
    ],
    whatItIsNot: [
      "Kein Therapeut oder medizinische Behandlung",
      "Kein Coach mit Zielen und Verantwortlichkeit",
      "Kein Habit-Tracker oder Produktivitäts-App",
    ],
    ...
    forWho: [
      "Selbstreflektierte Erwachsene, die Reflexion suchen",
      "Berufstätige, die mentale Belastung managen",
      "Alle, die Unterstützung ohne das Gewicht von Therapie wollen",
    ],
    notForWho: [
      "Menschen in akuter psychischer Krise (wir bieten Ressourcen)",
      "Menschen, die Diagnose oder medizinischen Rat suchen",
      "Menschen, die strukturierte Selbstoptimierungs-Programme wollen",
    ],
  },
};
...
• Remember you between sessions (your data stays on your device)

If you're struggling with something serious, please reach out to a professional. There's no shame in getting real help.`,
  },
  de: {
...
• Dich zwischen Sitzungen erinnern (deine Daten bleiben auf deinem Gerät)

Wenn du mit etwas Ernstem kämpfst, wende dich bitte an einen Fachmann. Es ist keine Schande, echte Hilfe zu bekommen.`,
  },
};
