...
export const contentTranslations: Translations = {
  ...
  "summary.couldntGenerate": { en: "Couldn't create your summary", de: "Zusammenfassung konnte nicht erstellt werden" },
  "summary.tryAgain": { en: "Please try again in a moment.", de: "Bitte versuche es gleich noch einmal." },
  "summary.whatWeDiscussed": { en: "What We Discussed", de: "Worüber wir gesprochen haben" },
  "summary.keyThemes": { en: "Key Themes", de: "Zentrale Themen" },
  ...
  "summary.downloaded": { en: "Your summary has been downloaded as a text file.", de: "Deine Zusammenfassung wurde als Textdatei heruntergeladen." },
  "summary.copiedToClipboard": { en: "Copied to clipboard", de: "In die Zwischenablage kopiert" },
  "summary.pasteAnywhere": { en: "You can now paste your summary anywhere you like.", de: "Du kannst deine Zusammenfassung jetzt überall einfügen." },
  "summary.messages": { en: "messages", de: "Nachrichten" },
  "summary.todayAt": { en: "Today at", de: "Heute um" },
  "summary.helpfulExercises": { en: "Exercises That Might Help", de: "Übungen, die dir guttun könnten" },
  "summary.breathingExercise": { en: "Breathing Exercise", de: "Atemübung" },
  "summary.calmYourMind": { en: "Calm your mind", de: "Komm zur Ruhe" },
  "summary.journalThoughts": { en: "Journal Your Thoughts", de: "Halte deine Gedanken fest" },
  "summary.reflectDeeper": { en: "Reflect a little deeper", de: "Reflektiere ein wenig tiefer" },
