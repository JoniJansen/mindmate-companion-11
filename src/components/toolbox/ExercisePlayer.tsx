          ...
          {isComplete ? (
            ...
            >
              ...
              {exercise.category === 'breathing' && (
                <motion.div
                  className="w-32 h-32 rounded-full bg-calm/20 mx-auto mb-8 flex items-center justify-center"
                  animate={isPlaying ? {
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-calm/40" />
                </motion.div>
              )}
              ...
              {/* Instruction */}
              <h2 className="text-xl font-medium text-foreground leading-relaxed mb-8">
                {step.instruction}
              </h2>
