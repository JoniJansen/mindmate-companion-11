...
export default function About() {
  ...
  const content = {
    en: {
      title: "About MindMate Assistant",
      subtitle: "Your companion for mental wellness",
      mission: {
        title: "Our Mission",
        content: "We believe everyone deserves a safe space to explore their thoughts and feelings. MindMate Assistant was created to be that space – a gentle, private companion that helps you understand yourself better, one conversation at a time.",
      },
      story: {
        title: "Our Story",
        content: "MindMate Assistant was born from a simple idea: mental wellness support should be accessible, private, and always available. We understand that not everyone can access therapy or counseling when they need it. That's why we built MindMate Assistant – to bridge the gap between daily struggles and professional care.",
      },
      values: [
        {
          icon: Shield,
      ...
      disclaimer: {
        ...
        content: "MindMate Assistant is a supportive wellness tool, not a replacement for professional mental health care. If you're experiencing a crisis or need professional help, please reach out to a licensed therapist or emergency services.",
      },
      team: {
        title: "The Team",
        content: "MindMate Assistant is created by MindMade, a small team passionate about making mental wellness accessible to everyone.",
    ...
    de: {
      title: "Über MindMate Assistant",
      subtitle: "Dein Begleiter für mentales Wohlbefinden",
      mission: {
        title: "Unsere Mission",
        content: "Wir glauben, dass jeder einen sicheren Raum verdient, um seine Gedanken und Gefühle zu erkunden. MindMate Assistant wurde erschaffen, um dieser Raum zu sein – ein sanfter, privater Begleiter, der dir hilft, dich selbst besser zu verstehen, ein Gespräch nach dem anderen.",
      },
      story: {
        title: "Unsere Geschichte",
        content: "MindMate Assistant entstand aus einer einfachen Idee: Unterstützung für mentales Wohlbefinden sollte zugänglich, privat und immer verfügbar sein. Wir verstehen, dass nicht jeder Zugang zu Therapie oder Beratung hat, wenn er sie braucht. Deshalb haben wir MindMate Assistant entwickelt – um die Lücke zwischen täglichen Herausforderungen und professioneller Betreuung zu schließen.",
      },
      values: [
        {
          icon: Shield,
      ...
      disclaimer: {
        ...
        content: "MindMate Assistant ist ein unterstützendes Wellness-Tool, kein Ersatz für professionelle psychische Gesundheitsversorgung. Wenn du eine Krise erlebst oder professionelle Hilfe benötigst, wende dich bitte an einen zugelassenen Therapeuten oder den Notdienst.",
      },
      team: {
        title: "Das Team",
        content: "MindMate Assistant wird von MindMade entwickelt, einem kleinen Team, das sich leidenschaftlich dafür einsetzt, mentales Wohlbefinden für alle zugänglich zu machen.",
        founder: "Jonathan Jansen",
        role: "Gründer",
