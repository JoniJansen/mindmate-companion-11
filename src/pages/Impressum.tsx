...
export default function Impressum() {
  ...
  const texts = {
    de: {
      ...
      medicalDisclaimerDesc: "MindMate ist kein Ersatz für professionelle psychologische oder medizinische Beratung, Diagnose oder Behandlung. Die App dient ausschließlich zur Unterstützung des persönlichen Wohlbefindens und der Selbstreflexion. Bei psychischen Problemen oder Erkrankungen wenden Sie sich bitte an qualifizierte Fachpersonen.",
    ...
    en: {
      ...
      medicalDisclaimerDesc: "MindMate is not a substitute for professional psychological or medical advice, diagnosis, or treatment. The app is intended solely to support personal well-being and self-reflection. If you are experiencing mental health problems or conditions, please consult qualified professionals.",
