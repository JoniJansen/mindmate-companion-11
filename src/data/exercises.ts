...
export const exercises: Exercise[] = [
  {
    ...
    steps: [
      ...
      { instruction: 'Breathe in slowly through your nose for 4 counts', duration: 8 },
      { instruction: 'Hold gently for 2 counts', duration: 5 },
      { instruction: 'Exhale slowly through your mouth for 6 counts', duration: 10 },
      { instruction: 'Breathe in again, feeling calm enter your body', duration: 8 },
      { instruction: 'Hold softly', duration: 5 },
      { instruction: 'Exhale, releasing tension', duration: 10 },
      { instruction: 'Breathe in once more, deep and slow', duration: 8 },
      { instruction: 'Hold gently', duration: 5 },
      { instruction: 'Exhale completely, letting go', duration: 10 },
      { instruction: 'One last deep breath in', duration: 8 },
      { instruction: 'Hold for a moment', duration: 5 },
      { instruction: 'And release, letting go completely', duration: 10 },
      { instruction: 'Gently open your eyes. Notice how you feel.', duration: 8 },
    ],
  },
  {
