...
• Sprich über alles, was dich beschäftigt
• Text- oder Sprachgespräche – wie es dir lieber ist
• Sanfte, verständnisvolle Antworten
• Verfügbar, wann immer du es brauchst

📓 TAGEBUCH MIT KI-REFLEXION

• Halte deine Gedanken und Gefühle fest
• Erhalte einfühlsame KI-Reflexionen zu deinen Einträgen
• Schreibimpulse, wenn dir die Worte fehlen
• Sichere, private Speicherung

📊 STIMMUNGS-TRACKING

• Tägliche Check-ins für emotionale Klarheit
• Visualisiere deine emotionalen Muster
• Erkenne Zusammenhänge in deinem Wohlbefinden
• Wöchentliche Zusammenfassungen

🧰 BERUHIGUNGS-TOOLBOX

• Geführte Atemübungen
• Erdungs-Techniken (5-4-3-2-1 Methode)
• Body-Scan Meditationen
• Schnelle Hilfe bei Anspannung
...
• Sprachgespräche mit natürlicher KI-Stimme
• Erweiterte Chat-Modi (Klären, Muster erkennen)
• Sitzungszusammenfassungen
• KI-gestützte Wochenrückblicke
...
• Text or voice conversations – whatever feels right
• Gentle, understanding responses
• Available whenever you need it

📓 JOURNAL WITH AI REFLECTION

• Capture your thoughts and feelings
• Receive empathetic AI reflections on your entries
• Writing prompts when words don't come easily
...
• Discover connections in your wellbeing
• Weekly summaries
...
• Voice conversations with natural AI voice
• Advanced chat modes (Clarify, Pattern recognition)
• Session summaries
